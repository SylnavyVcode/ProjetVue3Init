<template>
  <div>
    ...
    <div class="modal fade" id="modalIdProduct" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <input v-model="formProduct.libelle" type="text" class="form-control" name="" id="" aria-describedby="emailHelpId" placeholder="">
              <small id="emailHelpId" class="form-text text-muted">Help text</small>
            </div>
            <div class="mb-3">
              <label for="" class="form-label">Prix</label>
              <input v-model="formProduct.prix" type="number" class="form-control" name="" id="" aria-describedby="emailHelpId" placeholder="">
              <small id="emailHelpId" class="form-text text-muted">Help text</small>
            </div>
            <div class="mb-3">
              <label for="" class="form-label">Count</label>
              <input v-model="formProduct.count" type="number" class="form-control" name="" id="" aria-describedby="emailHelpId" placeholder="">
              <small id="emailHelpId" class="form-text text-muted">Help text</small>
            </div>

              <div  class="form-check form-check-inline">
                <input v-model="formProduct.status" class="form-check-input" type="checkbox" id="" value="option1">
                <label class="form-check-label" for="">disponible</label>
                </div>

          </div>
          <div class="modal-footer">
            <button @click="addProduct()" data-bs-dismiss="modal" aria-label="Close" type="button" class="btn btn-primary">Save</button>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-12">
          ...
          <div class="row m-3 text-end">
            ...
            <div class="col" v-else>
              <button v-if="db.account[0].admin" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#modalIdProduct">
